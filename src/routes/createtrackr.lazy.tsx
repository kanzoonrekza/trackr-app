				...
				<form>
					...
					<div className="mt-3 flex justify-between w-6/12">
						<div className="mr-2 w-full">
							<label className="block font-medium mb-1">Current Episode</label>
							<input className="border border-black w-full" />
						</div>
						<div className="ml-2 w-full">
							<label className="block font-medium mb-1">Total Episode</label>
							<input className="border border-black w-full" />
						</div>
					</div>
					<div className="flex justify-end w-6/12">
						<button className="mt-3 p-1 border border-black">Create</button>
					</div>
				</form>
			</div>
		</MainLayout>
